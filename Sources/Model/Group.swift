...
struct WorkspaceTabSnapshot: Codable {
  ...
  /// Bonsplit editor tab id (UUID string) -> pinned root path.
  let editorRootPathByTabId: [String: String]?
  ...
  init(_ tab: WorkspaceTab) {
    ...
    var editorRootMap: [String: String] = [:]
    ...
    for idStr in tabIdStrings {
      ...
      if kind == .editor,
        let rootPath = tab.editorRootPath(for: u),
        !rootPath.isEmpty
      {
        editorRootMap[idStr] = rootPath
      }
    }
    ...
    editorRootPathByTabId = editorRootMap.isEmpty ? nil : editorRootMap
  }
  ...
  init(from decoder: Decoder) throws {
    ...
    editorRootPathByTabId = try c.decodeIfPresent(
      [String: String].self, forKey: .editorRootPathByTabId)
  }
  ...
  func encode(to encoder: Encoder) throws {
    ...
    try c.encodeIfPresent(editorRootPathByTabId, forKey: .editorRootPathByTabId)
  }
}
