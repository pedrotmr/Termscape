...
final class TerminalSurface: Identifiable {
  ...
  init(workspaceId: UUID, workingDirectory: String? = nil) {
    ...
    currentWorkingDirectory = normalizedDirectory
    ...
    surfaceView = view
    hostedView = GhosttySurfaceScrollView(surfaceView: view)
  ...
  func updateCurrentWorkingDirectory(_ workingDirectory: String) {
    ...
    NotificationCenter.default.post(
      ...
      object: nil,
      userInfo: [
        Notification.Name.TerminalWorkingDirectoryDidChangeKey.workspaceId: workspaceId,
        Notification.Name.TerminalWorkingDirectoryDidChangeKey.surfaceId: id,
        Notification.Name.TerminalWorkingDirectoryDidChangeKey.path: normalized,
      ]
    )
